...
# 文本编码相关（encode_qwen / _parse_weighted_tag / _build_qwen_text_from_prompt /
# tokenize_t5_weighted）已搬到 training.text_encoding（ADR 0003 PR-A）。
# 顶部 import 已 re-export，sister script / test 不需改。
...
# training.state；caption / tokenize 已搬到 training.text_encoding（ADR 0003 PR-A）。
