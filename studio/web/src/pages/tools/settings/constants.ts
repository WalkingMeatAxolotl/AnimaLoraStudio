...
export const EMPTY: Secrets = {
  ...
  generate: { preview_every_n_steps: 3, attention_backend: 'auto', vae_precision: 'bf16', idle_timeout_minutes: 10, save_test_images: false, vram_policy: 'auto', te_precision: 'fp16' },
